...
/**
 * Core RFID rail processing logic.
 * Migrated from club.nsdn.nyasamarailway.util.RailRFIDCore.
 *
 * RFID rails check for matching tags on passing carts and emit redstone signals.
 */
public final class RailRFIDCore {
    ...
    /**
     * Check if the given tag matches the stored RFID pattern.
     * Supports '*' wildcard for any-match.
     */
    ...
    /**
     * Calculate signal strength based on cart velocity and distance.
     * Returns 0-15 redstone signal strength.
     */
