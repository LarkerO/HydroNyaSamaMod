...
/**
 * Platform-agnostic chunk load request.
 * Migrated from club.nsdn.nyasamarailway.event.ChunkLoaderHandler.
 * Used to keep chunks loaded around active railway entities.
 */
