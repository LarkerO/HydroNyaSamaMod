...
/**
 * Core sniffer rail logic for detecting cart information.
 * Migrated from club.nsdn.nyasamarailway.util.RailSnifferCore.
 *
 * Sniffer rails extract extended info from passing carts and convert it to redstone signals.
 */
