...
/**
 * Core reception rail logic for train control at stations. Migrated from
 * club.nsdn.nyasamarailway.util.RailReceptionCore.
 *
 * <p>Reception rails handle train stopping/starting at stations with timing control.
 */
