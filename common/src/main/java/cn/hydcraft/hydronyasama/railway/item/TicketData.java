...
/**
 * Platform-agnostic ticket data model.
 * Migrated from club.nsdn.nyasamarailway.item.ItemTicketBase.
 */
public final class TicketData {
    ...
    public void setRemainingUses(int uses) { this.remainingUses = Math.max(0, uses); }
