...
/**
 * Platform-agnostic data model representing a railway minecart's state. Migrated from
 * club.nsdn.nyasamarailway.entity.MinecartBase / TrainBase.
 */
public class MinecartData {
  ...
  public void setDir(int dir) {
    this.dir = Math.max(-1, Math.min(1, dir));
  }
  ...
  public void setPrevYaw(double prevYaw) {
