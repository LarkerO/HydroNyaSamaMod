...
/**
 * Extended data model for locomotive entities. Migrated from
 * club.nsdn.nyasamarailway.entity.LocoBase.
 */
public class LocoData extends MinecartData {
  ...
  public double getMotorBrake() {
    return motorBrake;
  }

  public void setMotorBrake(double motorBrake) {
